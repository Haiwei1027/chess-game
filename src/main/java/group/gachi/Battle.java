...
public class Battle {
    ...
    public void attack() {
        ...
        damage = (int) (roll.nextGaussian() * damageSigma + (damageMean - piece1.getWoundLevel()));
    ...
    public void heal() {
        ...
        int healAmount = (int)(maxHealth*0.5f);
        piece1.addHealth(healAmount);
    }


    public ChessPiece getPiece1() {
        return piece1;
    }

    public ChessPiece getPiece2() {
        return piece2;
    }

    public void paint() { //buffers the background, the bars, and the names.
        if (image == null) {
